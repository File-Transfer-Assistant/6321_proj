...
module testbench();
    ...
    localparam real TB_DRIVE_SKEW = 0.2;
...
`ifdef ENABLE_SDF
    initial $sdf_annotate("../../dc/fft/fft_processor_top.syn.sdf", uut);
`endif
    ...
    initial begin
        $dumpfile("tb_fft_dc.vcd");
        $dumpvars(0, testbench);
    end

    initial begin
        $readmemh("../../qsim_rtl/tb_fft/input_q1_15_v3.hex", input_mem);
        $readmemh("../../qsim_rtl/tb_fft/twiddle_q15.hex", twiddle_mem);
